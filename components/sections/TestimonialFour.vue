<template>
    <div class="brook-testimonial-area ptb--100 ptb-md--80 ptb-sm--60 bg_image--5" :style="{ backgroundImage: `url('/img/bg/championsLeague.jpg')` }">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="testimonial testimonial--creative">
                                <div class="brook-element-carousel nav-content testimonial-nav-content">
                                    ...
                                    >
                                        ...
                                        <swiper-slide class="testimonial-nav">
                                            <div class="testimonial-nav-style">
