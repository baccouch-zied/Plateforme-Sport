            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-8">
                    <div class="call-content text-center text-sm-start">
                        <h3 class="heading heading-h3 text-white wow move-up">Contactez nous</h3>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-4">
                    <div class="call-btn text-center text-sm-end mt_mobile--20 wow move-up">
                        <nuxt-link to="/contact" class="brook-btn bk-btn-white text-theme btn-sd-size btn-rounded">
                            Contact
                        </nuxt-link>
                    </div>
                </div>
